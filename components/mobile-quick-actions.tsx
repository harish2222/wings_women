...
export default function MobileQuickActions({ service = "general consultation" }: MobileQuickActionsProps) {
  ...
  const calendarUrl =
    "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Wings+Women+Center+Appointment&details=Fertility+consultation&location=Shop+115%2F116%2C+Ragamayuri+complex%2C+Kurnool";
